# This Makefile is for the Ark::View::Email extension to perl.
#
...
#     AUTHOR => q[haoyayoi <st.hao.yayoi@gmail.com>]
#     BUILD_REQUIRES => {  }
#     DIR => []
#     DISTNAME => q[Ark-View-Email]
#     NAME => q[Ark::View::Email]
#     NO_META => q[1]
#     PL_FILES => {  }
...
MAKE = make
FULLEXT = Ark/View/Email
BASEEXT = Email
PARENT_NAME = Ark::View
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Ark/View/Email.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Ark/View
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Ark/View
...
TO_INST_PM = lib/Ark/View/Email.pm

PM_TO_BLIB = lib/Ark/View/Email.pm \
	blib/lib/Ark/View/Email.pm
...
DISTNAME = Ark-View-Email
DISTVNAME = Ark-View-Email-0.01
...
manifypods : pure_all  \
	lib/Ark/View/Email.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Ark/View/Email.pm $(INST_MAN3DIR)/Ark::View::Email.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>haoyayoi &lt;st.hao.yayoi@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Ark/View/Email.pm blib/lib/Ark/View/Email.pm 
